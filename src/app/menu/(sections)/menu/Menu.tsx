            ...
            {menuCategory?.map((item) => {
              return (
                <button
                  ...
                  className={cn(
                    "w-fit border-b-2 border-b-transparent bg-primary px-6 py-4 font-semibold text-[#fffdf0] md:text-primary transition-all duration-300 ease-in-out md:bg-transparent",
