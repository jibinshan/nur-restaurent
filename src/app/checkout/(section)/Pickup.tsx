      ...
      <div className="flex w-full flex-col items-start justify-between gap-3 border-b-[2px] border-primary py-3 pb-5">
        ...
        <div className="flex w-full items-center justify-between gap-1 px-1 py-1">
          <div className="flex items-center gap-2">
            <div className="rounded-md px-4 py-4 text-sm">
              <MapPin />
            </div>
            <div>
            ...
            <div className="w-full rounded-lg">
              <div className="z-40 flex w-full flex-col gap-2">
                ...
                <Textarea
                  ...
                  rows={3}
                  className="border-none bg-white lg:w-4/5"
                />
              </div>
            </div>
          </div>
                  ...
                  <FormItem className="w-full lg:w-4/5">
                    <FormControl>
                      <Input
                        placeholder="Name"
                        {...field}
                        className="h-12 rounded-none border-b-0 border-l-0 border-r-0 border-t-0 bg-white outline-none focus-visible:ring-0"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
