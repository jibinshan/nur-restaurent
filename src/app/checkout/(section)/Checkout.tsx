    ...
    <section className="flex h-full w-full items-center justify-center">
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-2 py-[2.5rem]">
        <div className="flex flex-col-reverse gap-3 lg:flex-row lg:justify-between lg:gap-28">
          ...
          >
            <Button
              className="hidden w-fit p-0 lg:flex lg:gap-2"
              onClick={() => router.back()}
              variant="link"
            >
            ...
            <div className="flex w-full flex-col gap-3 border-b-[2px] border-primary py-3 pb-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <TabsList className="flex h-fit w-fit gap-1 rounded-full bg-primary px-1 py-1">
                <TabsTrigger
                  value="pickup"
                  className="rounded-full bg-transparent px-4 py-3 text-sm font-semibold text-white data-[state=active]:bg-[#fffdf0]"
                ...
                <div className="custom-scrollbar flex max-h-[300px] w-full flex-col overflow-x-auto overflow-y-scroll">
                  {cartItems.map((item) => (
                    <div
                      ...
                      className="flex w-full items-center justify-between border-b-[2px] border-b-primary py-2"
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col justify-between py-1">
                          <p className="line-clamp-1 text-lg font-normal text-primary">
                            {item.name}
                          </p>
                          {item.description && (
                            <p className="line-clamp-2 text-lg font-normal ">
                              {item.description}
                            </p>
                          )}
                ...
                <div className="flex flex-col gap-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className=" border-b-[3px] border-l-0 border-r-0 border-t-0 bg-white outline-none focus-visible:border-b-[2px]  focus-visible:ring-0 rounded-xl"
                    />
                    <Button >Apply</Button>
                  </div>
