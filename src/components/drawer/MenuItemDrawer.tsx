...
const MenuItemDrawer: FC<MenuItemPopupProps> = ({ children, item }) => {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="flex min-h-[620px] w-full flex-col justify-end border-[1px] border-[#fff5e5] bg-[#fff5e5] lg:hidden lg:w-0">
        <div
          style={{
        ...
        ></div>
        <Button
          className="/50 absolute right-2 top-2 z-50 rounded-full bg-[#fff5e5] px-2 py-1"
          variant="ghost"
        ...
        <div className="z-40 flex h-[450px] flex-col gap-5 overflow-y-scroll px-4">
          <div className="pt-48">
            <div className="rounded-lg bg-[#fffdf0] px-5 py-6">
              {item && (
          ...
          {GetModifiersFromItemId(item).length > 0 && (
            <div className="rounded-lg bg-[#fffdf0] px-5 py-6">
              <div className="flex flex-col gap-4 space-y-2">
                <p className="w-full border-b-[0.5px] pb-3 text-lg font-semibold ">
                  Modifiers
                </p>
        ...
        {BetaMenuActive && (
          <DrawerFooter className="flex w-full flex-row justify-start gap-2">
            <div className="flex h-12 w-1/2 items-center justify-center gap-3 rounded-md bg-primary p-2 text-[#fffdf0]">
              <Button
            ...
            <Button
              type="submit"
              className="h-12 w-1/2 rounded-md text-base font-medium"
              onClick={() => {
